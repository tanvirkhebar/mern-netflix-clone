  ...
  return (
    <div className="hero-bg relative">
      ...
      <header className="max-w-6xl mx-auto flex items-center justify-between p-4 pb-10">
        ...
        <Link
          to={"/login"}
          className="text-black bg-white py-1 px-4 font-semibold rounded-full"
        >
          Sign In
        </Link>
      </header>
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        <form className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleFormSubmit}>
          <input
            type="email"
            className="p-4 flex-1 bg-black/80 border border-gray-700 rounded-full font-semibold"
            placeholder="Email address"
            value={email}
            onChange={(e) => setEmail(e.target.value)}
          />
          <button className="bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 rounded-full flex justify-center items-center font-semibold">
            Get Started
